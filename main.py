...
from loss.contrastive import EnhancedBalSCL
...
data_dir = datasets_dir if datasets_dir else '/data/datasets/data_from_web/Herb-LT_split42'
...
shutil.copyfile(__file__, os.path.join(exp_dir, os.path.basename(__file__)))
...
if __name__ == "__main__":
    ...
    for epoch in range(nb_epoch):
        ...
        with torch.no_grad():
            ...
            eval_recall = recall_score(all_targets, all_preds, average='macro') * 100
    ...
    for data_set in data_sets:
        ...
        test_recall = recall_score(all_targets, all_preds, average='macro') * 100
