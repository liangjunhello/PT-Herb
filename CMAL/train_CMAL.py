...
def train(nb_epoch, batch_size, store_name, resume=False, start_epoch=0, model_path=None, data_path=''):
    ...
    trainset = datasets.ImageFolder(root=data_path + '/train', transform=transform_train)
    trainloader = DataLoader(trainset, batch_size=batch_size, shuffle=True, num_workers=4)

    testset = datasets.ImageFolder(root=data_path + '/test', transform=transform_test)
    testloader = DataLoader(testset, batch_size=batch_size, shuffle=False, num_workers=4)

    model_params = {'num_classes': 180}
    ...
    optimizer = optim.SGD([
        {'params': net.classifier_concat.parameters(), 'lr': 0.0017},
        {'params': net.conv_block1.parameters(), 'lr': 0.0017},
        {'params': net.classifier1.parameters(), 'lr': 0.0017},
        {'params': net.conv_block2.parameters(), 'lr': 0.0017},
        {'params': net.classifier2.parameters(), 'lr': 0.0017},
        {'params': net.conv_block3.parameters(), 'lr': 0.0017},
        {'params': net.classifier3.parameters(), 'lr': 0.0017},
        {'params': net.Features.parameters(), 'lr': 0.0017}

    ],
        momentum=0.9, weight_decay=5e-4)

    max_val_acc = 0
    lr = [0.0017, 0.0017, 0.0017, 0.0017, 0.0017, 0.0017, 0.0017, 0.0017]
...
if __name__ == '__main__':
    data_path = './data_from_web/Herb-LT_split42'
    os.environ["CUDA_VISIBLE_DEVICES"] = "0"
    train(nb_epoch=128,             # number of epoch
